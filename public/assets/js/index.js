...
/***/ "./develop/js/components/m-gallery.js":
/*!********************************************!*\
  !*** ./develop/js/components/m-gallery.js ***!
  \********************************************/
...
class MGallery extends HTMLElement {
  ...
  constructor() {
    var _this$closest, _this$translations$la;
    super();
    _defineProperty(this, "imagesCount", null);
    _defineProperty(this, "storage", {});
    _defineProperty(this, "isDragging", null);
    _defineProperty(this, "dragX", null);
    _defineProperty(this, "dragForceX", null);
    _defineProperty(this, "dragDeltaX", null);
    ...
    var language = (_this$closest = this.closest('[lang]')) === null || _this$closest === void 0 ? void 0 : _this$closest.lang;
    var translations = (_this$translations$la = this.translations[language]) !== null && _this$translations$la !== void 0 ? _this$translations$la : this.translations.en;
    var imagesListElement = this.querySelector(':scope > ul');
    this.imagesCount = imagesListElement.childElementCount;
    this.template = Object.assign(document.createElement('template'), {
      innerHTML: "\n\t\t\t\t<div class=\"m-gallery__images\">\n\t\t\t\t\t".concat(imagesListElement.outerHTML, "\n\t\t\t\t</div>\n\t\t\t\t<div class=\"m-gallery__navigation-buttons\">\n\t\t\t\t\t<button class=\"a-button\" data-shape=\"circle\" data-action=\"previous-image\" aria-label=\"").concat(translations.previousImage, "\">\u2190</button>\n\t\t\t\t\t<button class=\"a-button\" data-shape=\"circle\" data-action=\"next-image\" aria-label=\"").concat(translations.nextImage, "\">\u2192</button>\n\t\t\t\t</div>\n\t\t\t\t<nav class=\"m-gallery__navigation\" aria-label=\"").concat(translations.navigationLabel, "\">\n\t\t\t\t\t<div class=\"a-pagination\" data-kind=\"dots\">\n\t\t\t\t\t\t<ul>\n\t\t\t\t\t\t\t").concat(Array.from({
        length: this.imagesCount
      }, (_, index) => index + 1).map(index => "<li><button data-index=\"".concat(index, "\" data-action=\"show-image\" aria-label=\"").concat(index, "\"></button></li>")).join(''), "\n\t\t\t\t\t\t</ul>\n\t\t\t\t\t</div>\n\t\t\t\t</nav>\n\t\t\t")
    });
    ...
    var isElementPartiallyInViewport = element => {
    ...
    var onPointerUp = () => {
      ...
      var newIndex = this.currentImage;
    ...
    this.imagesUlElement.addEventListener('scroll', () => {
      var newIndex = [...this.imgElements].findIndex(_ => _.getAttribute('data-is-intersecting') !== null);
  ...
  showImage(index) {
    var imageToShowElement = this.imagesUlElement.children[index - 1];
    if (imageToShowElement) {
      this.currentImage = index;
      var scrollLeft = imageToShowElement.getBoundingClientRect().left - this.getBoundingClientRect().left + this.imagesUlElement.scrollLeft;
      if (imageToShowElement) {
        this.imagesUlElement.scroll({
          left: scrollLeft,
          behavior: 'smooth'
  ...
  updateNav() {
    ...
    paginationButtonElements.forEach(paginationButtonElement => {
      var index = parseInt(paginationButtonElement.dataset.index, 10);
...
/***/ "./develop/js/components/m-video.js":
/*!******************************************!*\
  !*** ./develop/js/components/m-video.js ***!
  \******************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
class MVideo {
  ...
  show() {
    ...
    if (animate === true) {
      ...
      var fadeOutAnimation = cookieBannerElement.animate({
        opacity: 0
      }, {
        delay: 150,
        duration: 300
    ...
    (_window$_paq = window._paq) === null || _window$_paq === void 0 || _window$_paq.push(['trackEvent', 'Video', 'Show', iframeElement.dataset.src]);
  }
}
document.mVideos = [];
...
/*!*****************************!*\
  ...
  \*****************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _components_m_gallery__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./components/m-gallery */ "./develop/js/components/m-gallery.js");
/* harmony import */ var _components_m_video__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/m-video */ "./develop/js/components/m-video.js");
